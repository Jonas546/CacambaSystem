...
class FinanceiroController extends Controller
{
    ...
    public function show_gastos(Request $request)
    {
        ...
        ->whereBetween('gastos.data', array($t->date_converter($request->data_inicio), $t->date_converter($request->data_fim)))
        ->get();
    ...
    public function show_receitas(Request $request)
    {
        ...
        $table = Locacao::whereBetween('inicio', array($t->date_converter($request->data_inicio), $t->date_converter($request->data_fim)))
        ->get();
